      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="inner">
              ...
              <nav>
                <ul class="nav masthead-nav" style="margin-right: -22%">
				  ...
				  <li class="active"><?php echo anchor('user/connexion','Connexion'); ?></li>
          ...
          <div class="inner cover">
			<?php 
				if($c==1){echo '<p id="erreur" class="form_erreur">Mot de passe ou email incorrecte!</p>';} 
			?>
            <div class="w3-card-4" style="background-color: white;">
				...
				<div class="w3-container">
					<form id="inscription" name="inscription" method="POST">
						...
						<input type="password" id="m2p" name="m2p" class="form-control" placeholder="Mot de passe" onkeyup="vpass()" required>
						<input type="submit" id="btInscription" name="btInscription" class="w3-btn w3-light-blue" value="Connexion">
